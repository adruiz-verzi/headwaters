...
<div class="wrap">
  ...
  <div id="view-tto">
    <p class="tto-intro">Licensable software from university tech-transfer offices, the channel every SVS
      portfolio company actually came through. <b>University of Utah today; Utah State, BYU, and UVU next,</b>
      then the top research universities nationwide. Each is a faculty-invented technology available to license
      now, with the inventor's research profile attached. Already-licensed inventions leave this list, so what
      you see is the pipeline ahead, not deals already done.</p>
    <div class="controls">
